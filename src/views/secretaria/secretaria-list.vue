...
<div class=" field column column is-12" style="width: 850px; margin-top: 15px;">
  ...
  <tbody>
    <tr>
      <td><p>01</p></td> 
      <td>Carol dos santos</td>
      <td>R$ 2.000,00</td>
      <td><button class="button is-link is-focused"><p>Detalhes</p></button></td>
    </tr>
     <tr>
         <td><p>02</p></td> 
      <td>Julia soares</td>
