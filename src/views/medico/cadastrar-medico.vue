<template class="cadastromedico">
     <div>
          <div>
               <h1 class="Titulo"> Cadastro de Medico </h1>
          </div>
          ...
          <br>
               <div>
                    <label class="label"><p>CRM: </p></label>
                    <input class=" input is-link" type="text" style="width: 220px; height: 30px; ">
               </div>
          <br>
               <div>
          ...
          <br>
               <div>
                    <label class="label"><p>Consultorio: </p></label>
                    <input class=" input is-link" type="text" style="width: 220px; height: 30px; ">
               </div>
          <br>
               <div>
                    <label class="label"><p>% Participação: </p></label>
                    <input class=" input is-link" type="text" style="width: 220px; height: 30px; ">
               </div>
          <br>
               <div>
                    <label class="label"><p>Especialidade:</p></label>
                    <input class=" input is-link" type="text" style="width: 220px; height: 30px; ">
               </div>
          <br> 
               <div>
